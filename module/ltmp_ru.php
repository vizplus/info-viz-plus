...
$ltmp_preset['ru']=[
	...
	'ops-history'=>[
		...
		'create_invite'=>'Выписан чек на <span class="view-tokens">{tokens}</span> с кодом проверки <span class="view-key check-invite-public-action">{key}</span>',
		'claim_invite_balance'=>'Погашен чек с кодом <span class="view-key check-invite-secret-action">{key}</span>',
		'use_invite_balance'=>'Погашен чек с кодом <span class="view-key check-invite-secret-action">{key}</span>',

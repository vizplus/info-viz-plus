...
$ltmp_preset['en']=[
	...
	'ops-history'=>[
		...
		'create_invite'=>'A check for <span class="view-tokens">{tokens}</span> was created with a validation code <span class="view-key check-invite-public-action">{key}</span>',
		'claim_invite_balance'=>'A check with a code <span class="view-key check-invite-secret-action">{key}</span> was redeemed',
		'use_invite_balance'=>'A check with a code <span class="view-key check-invite-secret-action">{key}</span> was redeemed',
